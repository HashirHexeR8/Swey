...
@Composable
fun SocialMediaScreen(socialMediaState: SocialMediaState) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Row(
            ...
            Image(painter = painterResource(id = R.drawable.ic_back_arrow),
                ...
                modifier = Modifier
                    .size(18.dp)
                    .clickable { socialMediaState.onDismiss() })
        ...
        Column {
            SocialMediaItem(type = SocialMediaTypes.INSTAGRAM, iconRes = R.drawable.ic_instagram) {
                socialMediaState.onInstagramShare()
            }
            SocialMediaItem(type = SocialMediaTypes.TWITTER, iconRes = R.drawable.ic_twitter) {
                socialMediaState.onTwitterShare()
            }
            SocialMediaItem(type = SocialMediaTypes.FACEBOOK, iconRes = R.drawable.ic_facebook) {
                socialMediaState.onFacebookShare()
            }
            SocialMediaItem(type = SocialMediaTypes.TIKTOK, iconRes = R.drawable.ic_tiktok) {
                socialMediaState.onTikTokShare()
            }
        }
    }
}
