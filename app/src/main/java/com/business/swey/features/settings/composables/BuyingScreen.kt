...
@Composable
fun BuyingScreen(buyingScreenState: BuyingScreenState) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Row(
            ...
            Image(painter = painterResource(id = R.drawable.ic_back_arrow),
                ...
                modifier = Modifier
                    .size(18.dp)
                    .clickable { buyingScreenState.onDismiss() })
        ...
        SettingsItem(title = "Purchase history", iconRes = R.drawable.ic_history,
            onClick = {
                buyingScreenState.onSettingsClick(BuyingSettingType.HOW_TO_BUY)
            })
        SettingsItem(title = "How to buy Authentic items", iconRes = R.drawable.ic_authentic,
            onClick = {
                buyingScreenState.onSettingsClick(BuyingSettingType.PURCHASE_HISTORY)
            })
    }
}